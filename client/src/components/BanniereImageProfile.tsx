  ...
  return (
    <section className="w-full relative -z-40">
      <div className="w-full h-[350px] relative">
        <img
          src={banniereProfileIamge}
          alt="Banniere Image Profile"
      ...
      <div className="absolute top-0 left-0 w-full h-[350px] bg-black opacity-60 flex flex-col items-start justify-center  pl-40">
        <h1 className="text-5xl top-[50%] font-bold text-white">
          Bienvenue
        ...
        {user?.is_admin ? (
          <p className="text-lg  text-white">
            Explorez les fonctionnalités avancées pour gérer efficacement <br />
