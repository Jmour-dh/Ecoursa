  ...
  return (
    <section className='min-h-screen flex flex-col justify-center items-center' style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover' }}>
      <div>
        ...
        <form className='w-[385px] h-[235px] bg-violent-violet-200 rounded-lg flex flex-col items-center'>
          ...
          <div className="relative mx-5">
            ...
            <input className='w-[345px] h-[34px] pl-10 rounded focus:outline-none' type="email" placeholder='Email' />
          </div>
          ...
          <button className='w-[345px] text-lg text-white bg-violent-violet-600 px-5 py-2 rounded hover:bg-violent-violet-300 hover:text-black'>Se connecter</button>
        </form>
